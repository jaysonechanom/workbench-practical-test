...
class UpdateTimesheetUseCase extends FutureUseCaseWitHParams <int, TimesheetModel>{
  const UpdateTimesheetUseCase(this._repo);

  final TimesheetRepo _repo;

  @override
  Future<int> call(TimesheetModel params) => _repo.updateTimesheet(params);
